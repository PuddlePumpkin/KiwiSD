...
def convertmodel(ckpt_path:str = None, vae_path:str = None, config_path:str = None, dump_path:str = None):
        ...
        inputDict["original_ckpt_path"] = ckpt_path
        ...
        converted_vae_checkpoint = convert_ldm_vae_checkpoint(checkpoint, inputDict["vae_path"], vae_config)
        ...
        pipe.save_pretrained(inputDict["dump_path"])
